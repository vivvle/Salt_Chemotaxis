...
Using CRISPR/Cas9 editing technology, we recovered two reduction-of-function gcy-22 alleles. We then performed salt chemotaxis assays with these alleles.
```{r}
salt_data <- salt %>%
